...
DEFAULT_MODEL = '/app/dockers/chopchop_allen_2018/indel_prediction/predictor/model_output_10000_0.01000000_0.01000000_-0.607_theta.txt_cf0.txt'
...
def main(target, cut_site):
    target_seq = str(target)
    pam_idx = cut_site+5
    theta_file = DEFAULT_MODEL
    profile, rep_reads, in_frame = predictMutations(theta_file, target_seq, pam_idx)

    return profile, in_frame
